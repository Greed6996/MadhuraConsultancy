...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-brand-navy">
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="https://wa.me/918876763028?text=Hey%2C%20i%20want%20to%20enroll" target="_blank" rel="noopener noreferrer" className="bg-brand-amber hover:bg-brand-amber-hover text-brand-navy font-semibold px-6 py-2.5 rounded-full transition-transform hover:-translate-y-0.5 active:translate-y-0 duration-200">
              Enroll Now
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-brand-navy border-b border-white/5 py-4 px-6 flex flex-col gap-4 shadow-xl">
            ...
            <a href="https://wa.me/918876763028?text=Hey%2C%20i%20want%20to%20enroll" target="_blank" rel="noopener noreferrer" className="bg-brand-amber text-brand-navy font-semibold px-6 py-3 rounded-full w-full text-center inline-block mt-2">
              Enroll Now
            </a>
          </div>
        )}
      ...
      {/* HERO SECTION */}
      <section id="home" className="relative z-10 w-full min-h-[100svh] flex flex-col justify-center overflow-hidden">
        <div className="w-full flex flex-col items-center justify-center pt-32 pb-20 px-4 relative z-10">
          <motion.div
          ...
          <TypewriterEffectSmooth
            ...
            className="my-0 z-20 relative"
            cursorClassName="bg-brand-amber"
          />

          {/* Sparkles Effect */}
          <div className="w-full max-w-[40rem] h-40 relative my-4 -mt-2">
            {/* Gradients */}
            <div className="absolute inset-x-0 top-0 bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-[2px] w-3/4 mx-auto blur-sm" />
            ...
            <div className="absolute inset-x-0 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[5px] w-1/4 mx-auto blur-sm" />
            ...
            <div className="absolute inset-0 w-full h-full bg-brand-navy [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
          </div>
          ...
          <motion.p
            ...
            className="-mt-16 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-lg md:text-xl font-medium tracking-tight text-transparent max-w-2xl z-20 relative px-4"
          >
      ...
      <section className="relative z-10 py-32 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 font-medium">
            Contact us at <span className="text-brand-amber">+91 88767 63028</span>
          </p>
          <a href="https://wa.me/918876763028?text=Hey%2C%20i%20want%20to%20enroll" target="_blank" rel="noopener noreferrer" className="bg-brand-amber hover:bg-brand-amber-hover text-brand-navy font-bold text-lg px-10 py-4 rounded-full transition-transform hover:-translate-y-1 duration-300 inline-flex items-center justify-center gap-2 mx-auto">
      ...
      <footer id="contact" className="relative z-10 bg-[#070A11] py-12 px-6 border-t border-white/5">
        <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-6 h-6 rounded transform rotate-45 bg-gradient-to-tr from-brand-amber to-yellow-300 flex items-center justify-center transition-transform duration-300 group-hover:rotate-90">
              <div className="w-3 h-3 bg-[#070A11] rounded-sm transform -rotate-45" />
            </div>
            <div>
              <span className="font-heading font-bold text-lg text-white group-hover:text-brand-amber transition-colors">
                Madhura<span className="text-brand-amber">.</span>
              </span>
              <p className="text-xs text-gray-500 mt-1">Where Learning Meets the Future.</p>
              <p className="text-xs text-gray-400 mt-1 font-medium">Phone: +91 88767 63028</p>
            </div>
          </Link>
          ...
          <div className="flex gap-4">
            ...
            <a href="https://wa.me/918876763028?text=Hey%2C%20i%20want%20to%20enroll" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-brand-amber hover:text-brand-navy transition-colors font-bold text-[10px] tracking-tighter">
              WA
            </a>
          </div>
        </div>
